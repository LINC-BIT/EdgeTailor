...
static_offline_alg_model_manager_registery = {}
static_online_alg_model_manager_registery = {}

def alg_model_manager_register(name: Union[str, List[str]], stage):
    class _Register:
        def __init__(self, func):
            self.func = func
            ...
            for n in names:
                if stage == 'offline':
                    static_offline_alg_model_manager_registery[n] = func
                else:
                    static_online_alg_model_manager_registery[n] = func
