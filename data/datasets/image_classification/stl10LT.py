...
class ImbalanceSTL10(torchvision.datasets.STL10):
    ...
    def __init__(self, root, imb_type='exp', imb_factor=1.0, rand_number=0, train='train',
    ...
    def gen_imbalanced_data(self, img_num_per_cls):
        ...
        self.targets = self.labels
        assert new_data.shape[0] == len(new_targets), 'Length of data & targets do not match!'
