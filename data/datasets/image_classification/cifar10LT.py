...
class ImbalanceCIFAR10(torchvision.datasets.CIFAR10):
    ...
    def __init__(self, root, imb_type='exp', imb_factor=0.005, rand_number=0, train=True,
                 transform=None, target_transform=None, download=False, weighted_alpha=p.weighted_alpha):
        ...
        self.train = train
        #self.weighted_alpha=p.weighted_alpha
